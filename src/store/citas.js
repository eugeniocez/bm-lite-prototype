...
const SEED = [
  // HOY — traslapes intencionales para demo
  ...
  { id: 'c4', nombreCliente: 'Rodrigo Sánchez', celular: '8123456789', fecha: manana, hora: '13:00', nota: null, estado: 'Confirmada', origen: 'QuickBook', creadaEn: new Date().toISOString(), modificadaEn: new Date().toISOString() },
  ...
  { id: 'd4', nombreCliente: 'Alejandro Vega', celular: '8145678901', fecha: pasado, hora: '14:00', nota: null, estado: 'Cancelada', origen: 'QuickBook', creadaEn: new Date().toISOString(), modificadaEn: new Date().toISOString() },
  ...
  { id: 'e3', nombreCliente: 'Miguel Torres', celular: '8198765432', fecha: tres, hora: '12:00', nota: 'Barba también', estado: 'Confirmada', origen: 'QuickBook', creadaEn: new Date().toISOString(), modificadaEn: new Date().toISOString() },
